...
public class CAGridStatic {
	...
	public CAGridStatic(int size) {// Create new instance of simulation with size of grid maximum CA cycle and fraction of stem cells 
		...
		for (int x = 0; x < size; x++) { //  Loop through all the boxes in the grid 
		        for (int xx = x - 1; xx <= x + 1; xx++) {
						if(x!=xx) // Form links with their 8 immediate neighbours
